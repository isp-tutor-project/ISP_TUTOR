...
(lib.CScalecopy = function(mode,startPosition,loop) {
	...
	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f().s("#999999").ss(4.2,1,1).p("AM+G3IH+o5IADhnAVFnAIgBAzIgDBcIgCBGANhATQAPAMAAAcIgLBWIgOBoIgZC+IhkAAI+0AAIgFABQgSAChTAHIBBjDIBBjDQAAgcAPgM");
	this.shape_3.setTransform(-4,6.1);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f().s("#666666").ss(1.6,1,1).p("AAEhSIDvkPIAHgJAj5FrIHnooIAAgDAjvDBIAEgEIBvh+Aj5ElIHpor");
...
(lib.TC_TObject__CRadionomusic = function(mode,startPosition,loop) {
	...
	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f().s("#000000").ss(1,1,1).p("");
	...
	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#0080FE").s().p("");
	this.shape_14.setTransform(-1.7,35);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#0000FF").s().p("AFGCNIAAhNIAAgwIAAh9IAAg4IBBAAIAAA0IAAAwIAADoQgggPghgLgAmGCcIAAkJIA8AAIAADyQgeAKgdANgAlKhtIg8AAIAAg4ILMAAIAAA4gAlKhtgAFGilg");
...
(lib.TC_TObject__CRadio = function(mode,startPosition,loop) {
	...
	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f().s("#000000").ss(0.1,1,1).p("");
	this.shape_6.setTransform(14.5,9.3);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f().s("#000000").ss(1,1,1).p("");
	...
	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#CCCCCC").s().p("");
	...
	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#0000FF").s().p("AFGCNIAAhNIAAgwIAAh9IAAg4IAAA4IqQAAIg8AAIAAg4ILMAAIBBAAIAAA0IAAAwIAADoQgggPghgLgAmGCcIAAkJIA8AAIAADyQgeAKgdANgAmGhtg");
...
(lib.CRadio = function(mode,startPosition,loop) {
	...
	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f().s("#000000").ss(1,1,1).p("");
	...
	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#666666").s().p("");
	...
	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#CCCCCC").s().p("");
	...
	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#0000FF").s().p("AFGCNIAAhNIAAgwIAAh9IAAg4IAAA4IqQAAIg8AAIAAg4ILMAAIBBAAIAAA0IAAAwIAADoQgggPghgLgAmGCcIAAkJIA8AAIAADyQgeAKgdANgAmGhtg");
...
(lib.squarefishtank = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#000000").ss(1,1,1).p("AHfovIH2lUIAAVVIn2GyI2zgSIJEmmINvAGIAAGyAHfHSIH2AAAHfovIAAQBAmQuDIAAFUIAAP7AvUovIJElUIVlAAAvUovIJEAAINvAAAvUNyIAA2h");

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.lf(["#000000","#888888","#B0B0B0","rgba(222,222,222,0.149)","rgba(233,233,233,0.298)","#FFFFFF"],[0,0,0,0,0.89,1],-73,0,73,0).s().p("ArZLHIJEmlIpEGlIAA2gIJEAAIAAP7IAAv7INvAAIAAQBItvgGINvAGIAAGygALaEog");
	this.shape_1.setTransform(-25,17);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.lf(["#000000","#888888","#B0B0B0","rgba(222,222,222,0.149)","rgba(233,233,233,0.298)","#FFFFFF"],[0,0,0,0,0.89,1],-25.1,-8.5,37.9,-8.5).s().p("Aj6HSIH1AAIn1GygAD7HSgAj6HSIAAwBIH1lUIAAVVg");
...
(lib.TC_TObject__CBackgroundSun = function(mode,startPosition,loop) {
	...
	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFF00").s().p("AmWGWQhkhkgph+ILHAAIrHAAQgbhUAAhgQAAjtCoioQCpipDtAAQBWAABOAWQAcAIAbAMQBnAqBVBVQCoCoAADtQAABggbBUImAAAIAArcIAALcIAAF1QhOAWhWAAQjtAAipipgACkC0IGAAAQgpB+hkBkQhVBVhnAqQgbAMgcAIgAojC0g");
...
(lib.table = function(mode,startPosition,loop) {
	...
	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#000000").s().p("EAlWAIGIAAimMglWAAAIjkAAMgjmAAAIjzAAIAACrIAAirIDzAAIAACgIAAAQIjzgBIAAgEIgKAAIgCwfMBWTAAAIAANuIgYAAIAAAGIiBAAIjbAAIDbAAIAACmIAAALIgPAAIjMAEgAivIMIg1gFIAAgBIAAimIDkAAIAACmIAAAJIhRgBIAAAGIhegIgEglYAIKIgogEIERABIiSAEIglAAIgygBg");
...
(lib.CAlgaeSmall = function(mode,startPosition,loop) {
	...
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#009933").s().p("");
...
(lib.CAlgaeLarge = function(mode,startPosition,loop) {
	...
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#009933").s().p("");
	this.shape_2.setTransform(-0.5,0.4);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("rgba(102,255,0,0.298)").s().p("");
	this.shape_3.setTransform(0.1,-1.3);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("rgba(51,51,0,0.298)").s().p("");
...
(lib.calendarnew = function(mode,startPosition,loop) {
	...
	this.shape_39 = new cjs.Shape();
	this.shape_39.graphics.f().s("#999999").ss(1,1,1).p("");
